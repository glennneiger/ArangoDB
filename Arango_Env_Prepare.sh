#!/bin/bash
#   wget https://raw.githubusercontent.com/patelvijayg/ArangoDB/master/Arango_Env_Prepare.sh && . ./Arango_Env_Prepare.sh
set -e
echo "***INGONE BELOW ---- Error: No such container: arangodb"
